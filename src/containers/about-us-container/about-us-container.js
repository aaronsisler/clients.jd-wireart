  ...
  <div className="about-us-container">
    ...
    <div className="about-us-container__content">
      ...
      <div className="about-us-container__content-text">
        ...
        that ax over my shoulder, looking at branches and envisioning
        interesting pictures of toys to be carved. I began expanding my
      ...
      <div className="about-us-container__content-text">
        ...
        we visited each day to buy bread and milk. When I was old enough to make
        this trip for the family’s only two food items, I began to see cars and
        trucks that I had never imagined. I was fascinated by the beauty and
        strangeness of them all. With each new vehicle I saw, I would run all
        three miles home and share what I had seen. Because I was unable to
        describe the kind of vehicle, I began carrying a piece of scrap wire
        around my neck. That way, when I saw a car of interest, I could use the
        wire to make the outlined shape of it and take it home to share. Next, I
        began to add to the wire vehicle, to the point where I had created a
      ...
      <div className="about-us-container__content-text">
        ...
        interesting one as well. Although I had my own plans to return
        immediately to Zimbabwe after schooling, I had to unselfishly decide to
        use my gifts and talents of working with youth to be a Youth Minister in
